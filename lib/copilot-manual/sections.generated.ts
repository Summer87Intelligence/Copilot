...
export const COPILOT_MANUAL_GENERATED_SECTIONS: CopilotManualSection[] = [
  ...
  },
  {
    ...
    includeInToc: true,
    blocks: [
      { type: "paragraph", text: "Panorama financiero combina foto actual (caja y deuda de hoy) con evolución mensual por fecha de factura y fecha de recibo. Lectura ejecutiva para CEO y contador; para operar el día a día usá Cartera y Tesorería." },
      { type: "callout", variant: "info", text: "Finanzas usa dos lecturas distintas de cobro: «Cobros registrados» (recibos por fecha de recibo, pueden incluir facturas de meses anteriores) y «Cobrado aplicado» (cobro imputado a facturas del período, misma lógica que Cartera y Dashboard). No confundas «Diferencia operativa del mes» con deuda pendiente." },
      ...
      { type: "bullets", items: [
        ...
        "Mes en curso — acumulado parcial desde el 1.º del mes; no comparar contra meses cerrados.",
        "Último mes cerrado — mes calendario completo anterior; base de la comparación principal.",
        "Cobros registrados — recibos con fecha dentro del mes. Pueden superar ventas del mes si se recupera deuda anterior.",
        "Cobrado aplicado — en desglose por moneda: cobro imputado a facturas del período (contrato Cartera).",
        "Deuda actual · hoy — saldo pendiente vigente de clientes, todos los períodos; no depende del filtro mensual.",
        "Deuda vencida · hoy — parte de la deuda actual con vencimiento superado; coincide con la tabla de riesgo de cobranza por moneda.",
        "Diferencia operativa del mes — ventas menos cobros registrados en un mes cerrado; no equivale a deuda.",
        "Ventas vs cobros registrados — comparación de meses cerrados por fecha de comprobante y recibo.",
        "Evolución mensual — gráfico de ventas y cobros registrados; el mes en curso aparece como parcial.",
        "Próximos 30 días — caja proyectada = caja + cobros esperados − pagos próximos.",
        "Detalle avanzado — clientes, desglose por moneda y semana vs semana para revisión ejecutiva.",
      ] },
    ],
  },
  {
