...
export const COPILOT_MANUAL_GENERATED_SECTIONS: CopilotManualSection[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "callout", variant: "tip", text: "Usá el filtro de moneda (UYU/USD/Ambas) y el selector de período para ajustar la lectura. Los gráficos de tendencia muestran un bucket por mes para cada mes del período seleccionado." },
      { type: "bullets", items: ["Facturado del período — facturas emitidas dentro del rango seleccionado, neto de notas de crédito. Depende del período.","Cobrado del período — recibos registrados en Zeta dentro del rango seleccionado. Depende del período.","Por cobrar total — deuda activa actual de todos los clientes. No depende del período seleccionado.","Deuda vencida total — parte de la deuda activa cuya fecha de vencimiento ya pasó. No depende del período seleccionado.","Caja disponible — dinero disponible actual en Tesorería.","Caja después de pagos — caja disponible menos pagos programados próximos. Si no hay pagos programados, coincide con la caja disponible y lo indica en el tooltip."] },
      { type: "callout", variant: "info", text: "UYU y USD nunca se suman ni se convierten. Con 'Todas las monedas', cada gráfico se muestra en dos bloques separados: uno UYU y uno USD, cada uno con su propia escala independiente." },
      { type: "bullets", items: ["[1] Ventas por mes — evolución mensual de facturación neta del período seleccionado. Con 'Todas las monedas': dos gráficos separados (UYU y USD) con escalas independientes.","[2] Cobros por mes — evolución mensual de cobros reales. Mismo comportamiento que [1].","[3] Ventas vs Cobros — facturado vs cobrado para el período. Incluye el chip 'Cobranza: X% · Pendiente: Y%'. Con 'Todas las monedas': dos gráficos separados (UYU y USD).","[4] Deuda por antigüedad — distribución del saldo vencido por bucket basado en fecha de vencimiento: 0–30d, 31–60d, 61–90d, +90d. Con 'Todas las monedas': dos gráficos separados.","[5] Top 10 deudores — con moneda 'Ambas' se muestran dos bloques (UYU y USD). El subtítulo indica qué porcentaje del total de deuda de esa moneda concentran los top 10.","[6] Top 10 facturación histórica — con moneda 'Ambas', dos bloques UYU/USD. Histórico total por cliente.","[7] Estado de cartera — 4 indicadores de clientes: Clientes activos, Con deuda activa, Con deuda vencida (ámbar), Al día (verde). Los clientes se cuentan una sola vez aunque tengan deuda en más de una moneda. También muestra deuda activa UYU y USD por separado.","[9] Caja proyectada 30 días — línea de caja actual y proyección después de pagos programados.","[10] Efectividad de cobros — porcentaje de lo facturado que fue cobrado en el período (cobrado / facturado)."] },
      ...
      { type: "bullets", items: ["Resumen ejecutivo — banner coloreado con estado del negocio: 'Estado financiero: Estable / Atención / Crítico'. Incluye una tabla compacta de 5 KPIs (facturado, cobrado, por cobrar, vencido, caja) con valores UYU y USD en la misma fila. Máximo 3 chips: riesgo principal, señal positiva y acción sugerida.","Estado Estable — sin deuda vencida, sin clientes de riesgo alto y caja positiva después de pagos.","Estado Atención — hay al menos un cliente de riesgo alto, o hay deuda vencida, o la caja baja después de pagos.","Estado Crítico — 3 o más clientes de riesgo alto, o la caja queda negativa después de pagos."] },
      ...
      { type: "bullets", items: ["Período — elegís el rango de fechas. Por defecto muestra el mes actual al día de hoy. Si cambiás el período, los KPIs facturado y cobrado se recalculan para ese rango. La sección de tendencia mensual muestra el rango completo seleccionado.","Moneda — filtrá por UYU, USD o ambas. Cuando elegís ambas, cada card y cada gráfico mantiene las monedas separadas.","Los filtros no afectan Deuda activa (que siempre es all-outstanding al corte) ni el gráfico [6] (histórico total)."] },
