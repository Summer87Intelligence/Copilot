...
export const COPILOT_MANUAL_GENERATED_SECTIONS: CopilotManualSection[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "bullets", items: ["COBRANZA — Cobranza (hub operativo: KPIs, clientes a gestionar, agenda y alertas), Cartera (deuda y antigüedad), Clientes (directorio y ficha 360) y Acciones (tareas del día)."] },
      ...
      { type: "callout", variant: "tip", text: "Vista USD — el botón de moneda en Dashboard y Hoy te permite ver los valores en dólares. Elegí UYU, USD, UYU + USD (separado) o Todo en USD. En modo 'Todo en USD' se usa el tipo de cambio que configurás haciendo clic en el chip '1 USD = X UYU'." },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "bullets", items: ["Filtros compactos — Todos, Con deuda, Atrasados, Críticos, Sin contacto; más Todas / UYU / USD y buscador por nombre.","Total pendiente — UYU y USD en la misma fila, siempre en rojo (deuda). No se convierten ni suman monedas.","Atraso — en tablas operativas ves días reales (p. ej. hace 10 días), no solo rangos de antigüedad.","Contacto — solo aparecen WhatsApp o Email si el dato existe; no hay botones deshabilitados.","Tabla primero — la lista accionable queda arriba, sin bloques que ocupen media pantalla antes de ver clientes."] },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "bullets", items: [
        "Registrar cobro — disponible desde el botón superior 'Registrar cobro' y desde el botón en cada cliente de la lista 'Clientes a gestionar'.",
        "Permite registrar cobros manuales en UYU o USD.",
        "Impacta Tesorería inmediatamente cuando 'Afecta caja' está activo.",
        "No modifica facturas, recibos ni saldos de Zeta.",
        "Genera evidencia en el historial de cobranza.",
        "Requiere permisos de escritura sobre acciones (rol cobranza o superadmin).",
      ] },
