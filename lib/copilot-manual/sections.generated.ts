...
export const COPILOT_MANUAL_GENERATED_SECTIONS: CopilotManualSection[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "bullets", items: ["Datos — facturas, recibos y registros en tabla.","Reportes — cada reporte puede verse en pantalla o descargarse como PDF. Cubre cobranza, caja, ventas, ejecutivo mensual y ranking de clientes.","Panorama financiero — lectura general (no reemplaza Tesorería ni Cartera).","Agentes IA — briefings de lectura; no modifican datos."] },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "bullets", items: ["Reporte de deudores.","Cobranza mensual.","Caja mensual.","Ventas.","Ejecutivo mensual.","Clientes principales.","Estado de cuenta (desde la ficha del cliente)."] },
    ],
  },
  {
    id: "admin",
