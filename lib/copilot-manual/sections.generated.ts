...
export const COPILOT_MANUAL_GENERATED_SECTIONS: CopilotManualSection[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "bullets", items: ["Cargar movimiento manual — en la pestaña Movimientos, con el botón Agregar movimiento cargás fecha, descripción, monto, moneda, tipo (entrada o salida), cuenta y referencia. Sirve para registrar a mano lo que ves en el banco mientras la importación automática no está disponible.","Editar y eliminar — cada fila tiene acciones para editar sus datos o eliminarla.","Estados de cada movimiento: Pendiente (sin identificar), Sugerido (hay una coincidencia propuesta), Conciliado (confirmado por un usuario), Ignorado (descartado a propósito) y Revisar (necesita decisión manual). Desde la tabla podés marcar Conciliar, Ignorar o Reabrir.","Conciliación — la pestaña Conciliación resume los grupos a revisar; la conciliación automática con sugerencias llega en una próxima etapa.","Importar extracto — la importación automática de PDF/CSV/Excel de Santander (sin OCR) queda para una próxima etapa."] },
