...
export const COPILOT_MANUAL_GENERATED_SECTIONS: CopilotManualSection[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "bullets", items: ["Importar extracto — subí un PDF, CSV o Excel exportado desde Santander. En V1 el PDF debe tener texto extraíble; no usamos OCR. Si el PDF no puede leerse, exportá CSV o Excel.","Estados de cada movimiento: Pendiente (sin identificar), Sugerido (hay una coincidencia propuesta), Conciliado (confirmado por un usuario), Ignorado (descartado a propósito) y Revisar (necesita decisión manual).","Conciliación — la pestaña Conciliación agrupa ingresos y egresos del banco sin identificar, cobros Zeta no vistos en banco y pagos de Copilot no vistos en banco.","Formas de transferencia — los aliases cargados en la ficha de cada cliente se usan para sugerir a qué cliente pertenece un movimiento."] },
      { type: "callout", variant: "warning", text: "Importar movimientos NO modifica la caja automáticamente. Primero se importan y se sugieren coincidencias; recién cuando confirmás una conciliación se registra el efecto correspondiente." },
    ],
  },
  {
    id: "tareas-diarias",
    ...
    blocks: [
      ...
      { type: "bullets", items: ["Las tareas se generan según tus permisos y los módulos que podés ver. Si no tenés acceso a un módulo, sus tareas no aparecen en tu lista.","Estados: Pendiente, En progreso, Completada, Pospuesta y Cancelada.","Prioridades: Alta, Media y Baja — lo urgente primero.","Relación con otros módulos — las tareas pueden venir de Cobranza (clientes a gestionar), Tesorería (pagos por confirmar), Movimientos bancarios (movimientos por conciliar) o Mesa de ayuda (tickets asignados).","Usá Actualizar tareas para revisar pendientes del día (disponible en la siguiente fase)."] },
    ],
  },
  {
    id: "rutinas",
