...
export const COPILOT_MANUAL_GENERATED_SECTIONS: CopilotManualSection[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "bullets", items: ["Caja — saldo disponible cargado al corte. Arriba del formulario: ¿Qué querés registrar? (Ingreso, Egreso o Pago programado).","Pagos próximos — resumen UYU/USD (30 días), lista de próximos pagos, recurrentes e historial. Un solo botón principal «+ Nuevo pago»; recurrentes con «+ Nuevo recurrente». No afectan caja hasta confirmarse.","Movimientos — ingresos y egresos confirmados que ajustan tu caja. Incluye importador bancario (extracto CSV/XLSX) y control contable.","Cobranza del mes — recibos cobrados en el período seleccionado, filtrable por fecha y moneda. Solo lectura desde Zeta."] },
      { type: "bullets", items: ["Pagos próximos — orden de la pantalla: (1) resumen UYU/USD próximos 30 días, (2) tabla de próximos pagos con «+ Nuevo pago», (3) recurrentes con «+ Nuevo recurrente», (4) historial de pagados/cancelados.","Formularios unificados — al crear o editar un pago usás los mismos campos: Concepto, Categoría, Moneda, Monto y Vencimiento.","Recurrentes — Copilot genera automáticamente cada vencimiento en la lista de próximos pagos. Pausar no borra historial.","Confirmar pago — desde la tabla podés marcar un pago como ejecutado; opcionalmente registra el egreso en caja."] },
