...
export const COPILOT_MANUAL_GENERATED_SECTIONS: CopilotManualSection[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "bullets", items: ["HOY — pantalla de operación diaria (caja, cobros y prioridades del día) y Tareas diarias (tu lista operativa del día según permisos)."] },
      ...
      { type: "bullets", items: ["TESORERÍA — Tesorería (caja, pagos y compromisos operativos) y Movimientos bancarios (extractos Santander y conciliación)."] },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "bullets", items: ["Navegar por todas las secciones permitidas según rol y permisos.","Ver dashboards, fichas de clientes, movimientos y deuda (donde haya acceso de lectura).","Abrir reportes en pantalla y descargar PDFs — son operaciones de lectura.","Ver Movimientos bancarios (donde haya acceso de lectura) — importar y conciliar requiere permiso de escritura.","Consultar alertas, notificaciones y Agentes IA."] },
  ...
  },
  {
    ...
    includeInToc: true,
    blocks: [
      { type: "paragraph", text: "Movimientos bancarios es el módulo donde importás extractos del banco (Santander en esta versión) y conciliás lo que pasó en el banco contra lo que Copilot y Zeta ya conocen: cobros Zeta, ingresos y egresos manuales, pagos programados y recurrentes, y clientes por sus formas de transferencia." },
      { type: "bullets", items: ["Diferencia con Tesorería — Tesorería es tu caja operativa (lo que cargás y confirmás vos). Movimientos bancarios es lo que realmente pasó en el banco según el extracto. Conciliar es cruzar ambas fuentes.","Diferencia con Zeta — Zeta registra facturas y cobros del sistema contable. El extracto muestra la plata que entró y salió de la cuenta. Un cobro Zeta puede no verse en el banco (efectivo) y un movimiento del banco puede no estar en Zeta (gastos, transferencias internas)."] },
      { type: "bullets", items: ["Cargar movimiento manual — en la pestaña Movimientos, con el botón Agregar movimiento cargás fecha, descripción, monto, moneda, tipo (entrada o salida), cuenta y referencia.","Importar extractos — en la pestaña Importar podés subir uno o varios PDFs de Santander, previsualizar y confirmar la importación.","Estados de cada movimiento: Pendiente (sin identificar), Sugerido (hay una coincidencia propuesta), Conciliado (vinculado con un pago de Tesorería), Ignorado (descartado a propósito) y Revisar (necesita decisión manual).","Conciliación — en la pestaña Conciliación Copilot sugiere coincidencias entre movimientos del banco y pagos programados de Tesorería. Podés Conciliar o Ignorar cada movimiento. Conciliar vincula el movimiento bancario con un pago de Tesorería; no modifica el pago automáticamente.","Qué NO hace todavía la conciliación: no marca pagos como pagados automáticamente, no modifica caja y no crea gastos automáticamente."] },
      { type: "callout", variant: "warning", text: "Cargar o marcar movimientos bancarios NO modifica la caja de Tesorería automáticamente. Movimientos bancarios es una vista del banco para revisar y conciliar; el impacto en caja se registra por separado." },
    ],
  },
  {
    id: "tareas-diarias",
    ...
    includeInToc: true,
    blocks: [
      { type: "paragraph", text: "Tareas diarias es tu lista operativa del día. Cada usuario ve sus propias tareas según los módulos que puede ver: cobranza, tesorería, banco, mesa de ayuda, clientes y más." },
      { type: "bullets", items: ["Crear tarea — con el botón Nueva tarea cargás título, descripción, módulo, prioridad y fecha límite.","Completar y reabrir — tocá el casillero a la izquierda de cada tarea para marcarla completada; volvé a tocarlo para reabrirla.","Editar y eliminar — cada tarea tiene acciones para editar sus datos o eliminarla.","Filtros — Pendientes, Vencidas, Completadas y Todas. Las vencidas son las que tienen fecha límite anterior a hoy y siguen abiertas.","Las tareas se muestran según tus permisos y los módulos que podés ver. Si no tenés acceso a un módulo, sus tareas no aparecen en tu lista.","Estados: Pendiente, En progreso, Completada, Pospuesta y Cancelada. Prioridades: Alta, Media y Baja.","Relación con otros módulos — una tarea puede referirse a Cobranza (clientes a gestionar), Tesorería (pagos por confirmar), Movimientos bancarios (movimientos por conciliar) o Mesa de ayuda (tickets asignados)."] },
    ],
  },
  {
    id: "rutinas",
