...
export const COPILOT_MANUAL_GENERATED_SECTIONS: CopilotManualSection[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "bullets", items: ["Deuda actual — suma de todas las facturas abiertas del cliente. El atrasado ya está incluido dentro de la deuda actual.","Atrasado — parte de la deuda actual cuya fecha de vencimiento ya pasó. Ya está incluido en la deuda actual; no se suma aparte.","% atrasado — qué proporción de la deuda actual ya está atrasada. Cuanto más alto, más urgente."] },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "bullets", items: [
        "Deuda actual — suma de deuda activa por moneda (UYU y USD) de todos los clientes.",
        "Vencido — monto de facturas con vencimiento anterior a hoy. Incluido dentro de la deuda actual.",
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "bullets", items: [
        "Foto actual — Caja disponible, Deuda actual, Atrasado y Riesgo financiero al corte de hoy.",
