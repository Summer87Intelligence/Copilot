...
export const COPILOT_MANUAL_GENERATED_SECTIONS: CopilotManualSection[] = [
  ...
  },
  {
    ...
    includeInToc: true,
    blocks: [
      { type: "paragraph", text: "Hoy es la pantalla de operación diaria. Mirala cada mañana para saber qué resolver primero: caja, cobros urgentes y clientes con deuda vencida." },
      ...
      { type: "bullets", items: ["Tu día en una frase — la acción concreta sugerida con un CTA (clientes con deuda, agenda, Tesorería o acciones).","Estado del día (semáforo) — el badge Al día / Requiere atención / Atención crítica es clicable. Al tocarlo aparece un popover con las señales detectadas: clientes que requieren atención, caja post-pagos y métricas de cartera. Incluye accesos rápidos a Clientes, Tesorería y Acciones.","Qué resolver hoy — hasta 3 prioridades ejecutivas con título, motivo y CTA directo: clientes con deuda para gestionar (vencidos y al día), agenda de cobranza pendiente y caja ajustada. Solo aparece cuando hay señales activas.","Caja disponible — dinero en Tesorería ahora. No es facturación ni deuda de clientes.","Deuda de clientes — Deuda actual (facturas abiertas). Es deuda de clientes, no plata en caja.","Pagos próximos — qué salidas están cargadas en Tesorería para los próximos días.","Caja proyectada — cuánto queda si se pagan todos los compromisos cargados (card de 30 días en el cockpit).","Caja al cierre del mes — estimación operativa inicial debajo del cockpit con selector Conservador (50% deuda) / Esperado (75%, default) / Optimista (100%). Fórmula: caja disponible + cobros estimados del escenario − pagos programados hasta fin de mes. Semáforo por moneda (Estable / Atención / Crítico): crítico si la caja proyectada es negativa o algún viernes queda negativo; atención si el margen queda por debajo del 15% de los pagos programados. Reparte cobros de forma lineal; no es predicción probabilística ni saldo bancario garantizado. Badge «Estimación inicial».","Clientes con deuda activa — todos los clientes con saldo pendiente, separados por moneda y ordenados por antigüedad de mora. Paginación 25/50/100. Los totales superiores reflejan toda la deuda activa sincronizada desde Zeta.","Detalle financiero del período — ventas del período, cobrado aplicado y pendiente con la misma reconciliación que Cartera y Dashboard.","Actividad del período — Ventas del período, Cobrado aplicado y Pendiente usan saldos de facturas aplicadas, no la suma de recibos por fecha de cobro.","Próximos 30 días — escenario operativo con caja, pagos y lo que podrías cobrar.","Generar PDF — en Clientes podés descargar el reporte de deudores."] },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "callout", variant: "info", text: "Datos es solo para consultar y verificar. Para gestión diaria usá Cartera, Tesorería o Acciones." },
      { type: "bullets", items: [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "callout", variant: "info", text: "Hoy y Acciones ya muestran prioridades con los datos actuales. Los agentes sumarán resúmenes coordinados cuando estén disponibles." },
      ...
      { type: "bullets", items: ["Mientras tanto — usá Hoy para operación diaria y Acciones para tareas concretas.","Dashboard Resumen — análisis ejecutivo del negocio.","Clientes 360 — ficha y cobranza por cliente."] },
    ],
  },
  {
    id: "reportes",
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "bullets", items: ["Resultado del período — bloque superior con tres cards: Ventas del período, Cobrado aplicado y Pendiente del período. Todas dependen del rango Desde/Hasta y usan la misma reconciliación que Cartera.","Situación actual — bloque inferior con cuatro cards: Deuda actual total, Deuda vencida, Caja disponible y Caja proyectada. Son foto al día de hoy; no se recalculan solo con el rango seleccionado.","Ventas del período — facturas emitidas dentro del rango, neto de notas de crédito.","Cobrado aplicado — cobros imputados contra facturas del período (facturado neto menos saldo pendiente al cierre del rango).","Pendiente del período — saldo pendiente de facturas del período al cierre (= ventas del período − cobrado aplicado).","Deuda actual total — total adeudado por clientes, incluyendo saldos de períodos anteriores.","Deuda vencida — parte de la deuda actual con vencimiento ya superado.","Caja disponible — dinero operativo en Tesorería ahora.","Caja proyectada — caja disponible menos pagos programados próximos (proyección operativa, no saldo bancario)."] },
      ...
      { type: "callout", variant: "info", text: "El Dashboard no reemplaza a Hoy (operación diaria) ni a Cartera/Tesorería para gestionar. Es una capa de análisis y reportes. Para gestionar clientes, registrar cobros o confirmar pagos, usá los módulos correspondientes." },
    ],
  },
  {
    id: "glosario",
