...
export const COPILOT_MANUAL_GENERATED_SECTIONS: CopilotManualSection[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "callout", variant: "tip", text: "Barra superior compacta — semáforo operacional (Al día / Requiere atención / Crítico) con detalle en popover al hacer clic; pill «Datos al…» con última sincronización Zeta; campana de notificaciones y selector de tema claro/oscuro. El detalle técnico (señales, fuentes) queda en el popover, no en la pantalla principal." },
    ],
  },
  {
    id: "hoy",
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "bullets", items: ["Acceso directo: Acciones ? pesta?a Agenda de cobranza (o /copilot/acciones?tab=agenda).","También en Hoy: resumen compacto con counts y link Ver agenda.","Vencidos ? seguimientos cuya fecha ya pasí, contactos incorrectos y clientes sin respuesta hace 5+ días.","Hoy ? seguimientos programados para hoy. Alta prioridad: hacer antes del cierre del día.","Próximos ? seguimientos futuros ordenados por fecha. Para planificar la semana.","Promesas ? clientes con promesa de pago activa, separadas en vencidas (crítico) y futuras (monitorear).","Contactados ? clientes contactados en los Últimos 7 días sin se?al pendiente. Estado 'Esperando respuesta'."] },
    ],
  },
  {
    id: "alertas",
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "callout", variant: "tip", text: "Columna Salud — unifica estado y riesgo en un solo indicador: Sin deuda, Al día, Atrasado o Crítico. No hay columnas duplicadas de Estado + Riesgo." },
      ...
      { type: "bullets", items: ["Filtros compactos — Todos, Con deuda, Atrasados, Críticos, Sin contacto; más buscador por nombre.","Total pendiente — UYU y USD en la misma fila, sin convertir ni sumar monedas.","Contacto — solo aparecen WhatsApp o Email si el dato existe; no hay botones deshabilitados.","Tabla primero — la lista accionable queda arriba, sin bloques que ocupen media pantalla antes de ver clientes."] },
      ...
      { type: "bullets", items: ["Total pendiente — suma de todas las facturas abiertas del cliente. El atrasado ya está incluido dentro de este total.","Atrasado — parte del total pendiente cuya fecha de vencimiento ya pasó. Ya está incluido en el total pendiente; no se suma aparte.","% atrasado — qué proporción del total pendiente ya está atrasada. Cuanto más alto, más urgente."] },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "callout", variant: "tip", text: "KPIs compactos — indicadores del período en cards pequeñas. La antigüedad (aging) queda visible arriba. El explorador de clientes arranca colapsado; usá el enlace a Clientes para la lista accionable." },
  ...
  },
  {
    ...
    includeInToc: true,
    blocks: [
      { type: "paragraph", text: "Finanzas es la lectura ejecutiva para CEO: foto actual de caja y deuda, facturación anual, tendencia, clientes que explican la deuda, caja proyectada a 30 días y riesgo de cobro. UYU y USD siempre separados — no se convierten ni suman." },
      ...
      { type: "bullets", items: [
        "Foto actual — Caja disponible, Total pendiente, Atrasado y Riesgo financiero al corte de hoy.",
      ...
      { type: "callout", variant: "info", text: "Para operar el día a día usá Hoy, Clientes y Cartera. Finanzas no reemplaza la gestión de cobranza." },
    ],
  },
  {
    id: "datos",
    ...
    blocks: [
      ...
      { type: "callout", variant: "info", text: "Datos es solo para consultar y verificar. Para gestión diaria usá Cartera, Tesorería o Acciones. Lenguaje ejecutivo: sin CTAs duplicados ni bloques técnicos en la vista principal." },
      { type: "bullets", items: [
