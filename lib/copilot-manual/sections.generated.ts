...
export const COPILOT_MANUAL_GENERATED_SECTIONS: CopilotManualSection[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "bullets", items: ["Tu día en una frase — la acción concreta sugerida con un CTA (clientes con deuda, agenda, Tesorería o acciones).","Estado del día (semáforo) — el badge Al día / Requiere atención / Atención crítica es clicable. Al tocarlo aparece un popover con las señales detectadas: clientes que requieren atención, caja post-pagos y métricas de cartera. Incluye accesos rápidos a Clientes, Tesorería y Acciones.","Qué resolver hoy — hasta 3 prioridades ejecutivas con título, motivo y CTA directo: clientes con deuda para gestionar (vencidos y al día), agenda de cobranza pendiente y caja ajustada. Solo aparece cuando hay señales activas.","Caja disponible — dinero en Tesorería ahora. No es facturación ni deuda de clientes.","Clientes por cobrar — facturas abiertas. Es deuda de clientes, no plata en caja.","Pagos próximos — qué salidas están cargadas en Tesorería para los próximos días.","Caja después de pagos — cuánto queda si se pagan todos los compromisos cargados.","Clientes con deuda activa — todos los clientes con saldo pendiente, priorizando vencidos. Hacé clic en una fila para ver el resumen de deuda, origen del dato y acción sugerida.","Detalle financiero del período — facturación, cobros y proyección del período seleccionado.","Próximos 30 días — escenario operativo con caja, pagos y lo que podrías cobrar.","Generar PDF — en Clientes podés descargar el reporte de deudores."] },
      { type: "callout", variant: "info", text: "Clientes con deuda activa — los datos provienen de facturas y saldos sincronizados desde Zeta. Los vencidos aparecen primero. Hacé clic en cualquier fila para ver el desglose: deuda total, deuda vencida, parte al día, días de atraso y origen del dato." },
      { type: "bullets", items: ["Deuda total — saldo pendiente activo del cliente en esa moneda. Viene de las facturas abiertas sincronizadas desde Zeta.","Deuda vencida — parte de la deuda cuya fecha de vencimiento ya pasó. Si es 0, el cliente tiene deuda pero todavía está dentro del plazo.","Deuda al día — diferencia entre deuda total y deuda vencida. Saldo pendiente todavía dentro del plazo.","Días de atraso — días desde la factura vencida más antigua. Aparece solo cuando hay deuda vencida registrada.","Fila expandida — hacé clic en una fila para ver el resumen completo: montos, estado (al día / requiere seguimiento), fuente del dato, moneda y datos de contacto.","Badge 'Deuda al día' — el cliente tiene saldo pendiente pero ninguna factura venció todavía.","Badge 'Vencido' — hay al menos una factura cuya fecha de vencimiento ya pasó."] },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "bullets", items: ["Por qué importa — cada card explica el motivo de la acción: qué pasó con ese cliente o caja para que sea prioritario ahora.","Siguiente paso — la card indica qué hacer a continuación: contactar al cliente, confirmar un pago, monitorear una promesa o registrar el resultado de un seguimiento programado.","Última gestión — canal, resultado y fecha de la última gestión registrada.","Prometió pagar — si hay una promesa activa, se muestra la fecha y el monto.","Próximo seguimiento — si agendaste un seguimiento, aparece la fecha.","La prioridad puede bajar si el cliente ya fue contactado o tiene una promesa futura.","El botón cambia a «Ver seguimiento» para ir directo al historial del cliente."] },
  ...
  },
  {
    ...
    includeInToc: true,
    blocks: [
      { type: "paragraph", text: "Dashboard Resumen es la vista ejecutiva del negocio: ventas, cobros, deuda, caja y evolución mensual en un solo lugar. Es complementario a Hoy (que muestra el día) y a Finanzas (que profundiza el análisis): Dashboard Resumen está pensado para una lectura rápida de todos los KPIs con gráficos interactivos." },
      { type: "callout", variant: "tip", text: "Usá el filtro de moneda (UYU/USD/Ambas) y el selector de período para ajustar la lectura. Los gráficos de tendencia siempre muestran los últimos 5 meses completos más el período actual." },
      { type: "bullets", items: ["Facturado — facturas emitidas del período, neto de notas de crédito. No incluye facturación histórica anterior al rango elegido.","Cobrado — recibos reales cobrados en el período (collectedInPeriod). No incluye estimaciones ni deuda resuelta fuera del período.","Deuda activa — saldo pendiente total de todos los clientes al corte (pendingAtCutoff). No es del período: es la posición al momento.","Deuda vencida — deuda cuya fecha de vencimiento ya pasó (buckets 31-60, 61-90, 90+ días). Usa la fecha de vencimiento de cada factura.","Caja disponible — saldo real en Tesorería al momento del corte.","Caja después de pagos — caja disponible menos los pagos programados para los próximos 30 días."] },
      { type: "callout", variant: "info", text: "UYU y USD nunca se suman: cada moneda es independiente. Las 6 KPIs grandes muestran cada moneda por separado." },
      { type: "bullets", items: ["[1] Ventas por mes — evolución mensual de facturación neta. Incluye el período actual aunque esté incompleto.","[2] Cobros por mes — evolución mensual de cobros reales. Puede superar a ventas si se cobran deudas anteriores.","[3] Ventas vs Cobros — barras agrupadas para comparar facturado y cobrado mes a mes.","[4] Deuda por antigüedad — distribución del saldo vencido por bucket de días (0-30, 31-60, 61-90, 90+). Cuanto más a la derecha, más crítico.","[5] Top 10 deudores — clientes con mayor saldo pendiente. Hacé clic para ir a la ficha del cliente.","[6] Top 10 facturación — facturación histórica total por cliente (Histórico total — sin filtro de período).","[7] Clientes por estado — distribución: sin deuda / deuda al día / deuda vencida / riesgo alto.","[8] Distribución por moneda — peso relativo de la deuda total en UYU vs USD.","[9] Caja proyectada 30 días — línea de caja actual y proyección después de pagos programados.","[10] Efectividad de cobros — porcentaje de lo facturado que fue cobrado en el período (cobrado / facturado)."] },
      ...
      { type: "bullets", items: ["Resumen ejecutivo — narrativa automática con estado del negocio: Al día / Requiere atención / Crítico. Incluye chips con las señales detectadas (clientes en riesgo, caja ajustada, deuda vencida).","Estado Al día — sin deuda vencida, sin clientes de riesgo alto y caja positiva después de pagos.","Estado Requiere atención — hay al menos un cliente de riesgo alto, o hay deuda vencida, o la caja baja después de pagos.","Estado Crítico — 3 o más clientes de riesgo alto, o la caja queda negativa después de pagos."] },
      { type: "bullets", items: ["Clientes críticos — tabla de los principales deudores con deuda vencida ordenados por urgencia. Clic en una fila lleva a la ficha del cliente.","Movimientos recientes — facturas emitidas y recibos cobrados del período seleccionado, ordenados por fecha descendente. Muestra hasta 20 movimientos."] },
      { type: "bullets", items: ["Período — elegís el rango de fechas. Por defecto muestra el mes actual al día de hoy. Si cambiás el período, los KPIs facturado y cobrado se recalculan para ese rango.","Moneda — filtrá por UYU, USD o ambas. Cuando elegís ambas, cada card y cada gráfico mantiene las monedas separadas.","Los filtros no afectan Deuda activa (que siempre es all-outstanding al corte) ni el gráfico [6] (histórico total)."] },
      { type: "callout", variant: "info", text: "El Dashboard no reemplaza a Cartera ni a Tesorería para operaciones del día a día. Es una capa de lectura ejecutiva. Para gestionar clientes, registrar cobros o confirmar pagos, usá los módulos correspondientes." },
    ],
  },
  {
    id: "glosario",
