...
export const HOY_COPY = {
  ...
  cashCurrentTip: "Cobros acumulados + movimientos manuales. No incluye deuda pendiente.",
  cashCollectedLabel: "Cobrado acumulado",
  cashCollectedTip: "Cobros registrados hasta hoy. Puede incluir períodos anteriores.",
