...
export const HOY_COPY = {
  ...
  cashCurrentTip: "Viene de Tesorería: saldo actual cargado + movimientos confirmados. Sin deuda de clientes.",
  cashCollectedLabel: "Cobrado en Tesorería",
  cashCollectedTip: "Cobros registrados como ingreso confirmado en Tesorería.",
