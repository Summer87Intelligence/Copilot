...
export const PIPELINE_EXPECTED_INTERVALS_MS: Record<string, number> = {
  // Tier A — cada 3 h
  [ZETA_PIPELINE_NAMES.SALDOS]: 3 * 60 * 60 * 1_000,
  [ZETA_PIPELINE_NAMES.VOUCHERS]: 3 * 60 * 60 * 1_000,
  [ZETA_PIPELINE_NAMES.COLLECTION_RECEIPTS]: 3 * 60 * 60 * 1_000,
  [ZETA_PIPELINE_NAMES.CUOTAS]: 3 * 60 * 60 * 1_000,
  // Tier B — cada 6 h
  [ZETA_PIPELINE_NAMES.VENDOR_PAYMENTS]: 6 * 60 * 60 * 1_000,
  [ZETA_PIPELINE_NAMES.COMPLETENESS_AUDIT]: 6 * 60 * 60 * 1_000,
  [ZETA_PIPELINE_NAMES.INTEGRITY_CHECK]: 6 * 60 * 60 * 1_000,
  [ZETA_PIPELINE_NAMES.RESYNC_WORKER]: 6 * 60 * 60 * 1_000,
  // Tier C — diario
  [ZETA_PIPELINE_NAMES.CONTACTS]: 24 * 60 * 60 * 1_000,
};
