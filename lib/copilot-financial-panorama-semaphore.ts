...
/** Solo mostrar badge prominente para estados que requieren acción. */
export function shouldShowProminentSemaphore(level: MetricSemaphoreLevel): boolean {
  return level === "attention" || level === "critical";
}

/** Indicador discreto para estados saludables. */
export function shouldShowSubtleSemaphore(level: MetricSemaphoreLevel): boolean {
