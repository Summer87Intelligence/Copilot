...
Fuente:
- URL original: https://zetasoftware.info/ayuda/apis/metodos-generales/
- URL final: https://zetasoftware.info/ayuda/apis/metodos-generales/
...
- [Métodos de la API - PreviousDatos de Conexión](https://zetasoftware.info/ayuda/apis/datos-de-conexion/)
- [Next - Métodos de la APIProtocolos soportados: SOAP y REST](https://zetasoftware.info/ayuda/apis/soap-y-rest/)
