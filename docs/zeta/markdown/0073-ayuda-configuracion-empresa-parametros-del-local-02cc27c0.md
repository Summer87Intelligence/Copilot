...
Fuente:
- URL original: https://zetasoftware.info/ayuda/configuracion/empresa/parametros-del-local/
- URL final: https://zetasoftware.info/ayuda/configuracion/empresa/parametros-del-local/
...
- [Parámetros del Local - PreviousPaíses y Departamentos](https://zetasoftware.info/ayuda/configuracion/empresa/paises/)
- [Next - Parámetros del LocalParámetros Generales](https://zetasoftware.info/ayuda/configuracion/empresa/parametros-generales-de-la-empresa/)
