# ¿Qué es y para que sirve la Extranet? - ZetaSoftware

Fuente:
- URL original: https://zetasoftware.info/ayuda/preguntas-frecuentes/generales/extranet/
- URL final: https://zetasoftware.info/ayuda/preguntas-frecuentes/generales/extranet/
...
La Extranet habilita a que las empresas puedan darle acceso a sus clientes a toda la información sobre sus cuentas corrientes y saldos, desde la web de ZetaSoftware. Tal como lo hacen en la web de los Bancos, los clientes podrán entrar a [ZetaSoftware.com](http://ZetaSoftware.com) y consultar Estados de Cuenta y demás datos financieros con cada uno de los proveedores que les haya dado acceso.

## ¿Qué es la Extranet de ZetaSoftware y para qué sirve?

Con el nombre de Extranet nos referimos a la forma en que las empresas que utilizan los módulos de [Gestión PyME](https://zetasoftware.info/gestion-pyme/) o [Facturación Profesional](https://zetasoftware.info/facturacion-profesional/) puedan darle acceso a sus clientes a la información de sus cuentas corrientes, histórico de comprobantes, saldos y vencimientos.
...
Si eres cliente de ZetaSoftware y utilizas los módulos de [Gestión PyME](https://zetasoftware.info/gestion-pyme/) o [Facturación Profesional](https://zetasoftware.info/facturacion-profesional/), y si eres el usuario Administrador (generalmente con código 1), con solo entrar a [ZetaSoftware.com](http://ZetaSoftware.com) y loguearte con tu email, podrás ir a tu perfil (tu nombre arriba a la derecha) y seleccionar la opción Extranet.  
...
Si ambas condiciones se cumplen, solo resta que el usuario entre a [ZetaSoftware.com](http://ZetaSoftware.com), ingrese con su email y contraseña de usuario, y luego seleccione la opción Extranet que se muestra en su perfil, arriba a la derecha, haciendo clic en su nombre.
...
-   Una vez dentro de la empresa, ir a Configuración » [Contactos, Clientes y Proveedores](https://zetasoftware.info/ayuda/configuracion/contactos/contactos-clientes-y-proveedores/).
-   Al desplegarse la grilla de los clientes y proveedores, se observará sobre la misma un botón **Extranet** (Este botón solo será visible para los usuarios de tipo Administrador o Supervisor).
...
[¿Qué es y para que sirve la Extranet? - Previous¿Cómo se utiliza la grilla de Seleccionar Empresa?](https://zetasoftware.info/ayuda/preguntas-frecuentes/generales/seleccionar-empresa/)[Next - ¿Qué es y para que sirve la Extranet?¿Qué son y para que sirven los Recordatorios?](https://zetasoftware.info/ayuda/preguntas-frecuentes/generales/recordatorios/)
...
- [Contactos, Clientes y Proveedores](https://zetasoftware.info/ayuda/configuracion/contactos/contactos-clientes-y-proveedores/)
- [Next - ¿Qué es y para que sirve la Extranet?¿Qué son y para que sirven los Recordatorios?](https://zetasoftware.info/ayuda/preguntas-frecuentes/generales/recordatorios/)
- [¿Qué es y para que sirve la Extranet? - Previous¿Cómo se utiliza la grilla de Seleccionar Empresa?](https://zetasoftware.info/ayuda/preguntas-frecuentes/generales/seleccionar-empresa/)
