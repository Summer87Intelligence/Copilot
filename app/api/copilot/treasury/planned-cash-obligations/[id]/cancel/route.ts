...
import { plannedCashObligationCancelBodySchema } from "@/lib/api/schemas/treasury-api-bodies";
...
export async function POST(
  ...
  try {
    ...
    const parsed = await parseAndValidateJsonBody(request, plannedCashObligationCancelBodySchema);
