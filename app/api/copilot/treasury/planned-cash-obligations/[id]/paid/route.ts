...
import { plannedCashObligationPaidBodySchema } from "@/lib/api/schemas/treasury-api-bodies";
import { requireCopilotModuleAccess, requireCopilotModuleWriteAccess } from "@/lib/auth/copilot-module-api-auth";
import { MSG_DB_USER } from "@/lib/copilot-data-integrity";
import { plannedCashObligationMarkPaid } from "@/lib/treasury/services/planned-cash-obligation-service";
...
export async function POST(
  ...
  try {
    ...
    const parsed = await parseAndValidateJsonBody(request, plannedCashObligationPaidBodySchema);
