...
import { treasuryInsightsOnly } from "@/lib/treasury/services/treasury-intelligence-service";
...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await treasuryInsightsOnly(auth.ctx.supabase, auth.ctx.tenantCompanyId, {
