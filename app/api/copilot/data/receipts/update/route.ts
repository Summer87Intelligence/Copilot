...
import { protoReceiptUpdateBodySchema } from "@/lib/api/schemas/copilot-api-bodies";
...
export async function PATCH(request: NextRequest) {
  try {
    ...
    const result = await protoUpdateReceipt(auth.ctx.supabase, id, patch);
