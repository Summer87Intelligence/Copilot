...
import { protoRestoreTaxObligation } from "@/lib/copilot-proto-crud-service";
      ...
      return NextResponse.json(
        {
          ok: false as const,
          code: "VALIDATION" as const,
          message: "Falta el identificador de la obligación fiscal.",
        },
        { status: 400 }
      );
    }
    const result = await protoRestoreTaxObligation(supabase, id);
