...
import { protoPaymentCreateBodySchema } from "@/lib/api/schemas/copilot-api-bodies";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await protoCreatePayment(auth.ctx.supabase, body);
