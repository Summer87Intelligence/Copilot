  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      <CopilotPageHeader
        ...
        title="Inicio"
        description={`Punto de entrada del módulo: visión de ${MOCK_COMPANY_NAME}, lectura del copiloto y acceso al motor de oportunidades — todo con el mismo menú lateral.`}
        readingKey={
          <CopilotReadingKey
            lines={[
              "Acá empieza todo.",
