          ...
          <CopilotCard className="lg:col-span-2">
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <div className="rounded-2xl bg-white/85 p-4 ring-1 ring-[var(--copilot-border)]">
                ...
                <p className="mt-2 text-xl font-semibold">{current.cash}</p>
              </div>
              <div className="rounded-2xl bg-white/85 p-4 ring-1 ring-[var(--copilot-border)]">
                <p className="text-xs font-semibold uppercase tracking-wide text-[var(--copilot-ink-muted)]">
                  Ventas
                </p>
                <p className="mt-2 text-xl font-semibold">{current.sales}</p>
              </div>
              <div className="rounded-2xl bg-white/85 p-4 ring-1 ring-[var(--copilot-border)]">
                <p className="text-xs font-semibold uppercase tracking-wide text-[var(--copilot-ink-muted)]">
                  Gastos
                </p>
                <p className="mt-2 text-xl font-semibold">{current.expenses}</p>
              </div>
            </div>
