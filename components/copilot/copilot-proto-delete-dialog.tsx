      ...
      <div className="fixed left-1/2 top-1/2 z-[70] max-h-[min(90vh,720px)] w-[min(100%,520px)] -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-2xl border border-[var(--copilot-border)] bg-[var(--copilot-card)] p-6 shadow-2xl">
        ...
        <div className="mt-5 flex flex-wrap justify-end gap-2">
          ...
          <button
            ...
            disabled={loading}
            onClick={onConfirm}
            className="rounded-xl bg-[var(--copilot-accent)] px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:opacity-95 disabled:cursor-not-allowed disabled:opacity-50"
          >
