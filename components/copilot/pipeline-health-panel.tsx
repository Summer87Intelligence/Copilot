...
const INTERVAL_LABELS: Record<string, string> = {
  // Tier A — cada 2 h
  [ZETA_PIPELINE_NAMES.SALDOS]: "cada 2 h",
  [ZETA_PIPELINE_NAMES.VOUCHERS]: "cada 2 h",
  [ZETA_PIPELINE_NAMES.COLLECTION_RECEIPTS]: "cada 2 h",
  [ZETA_PIPELINE_NAMES.CUOTAS]: "cada 2 h",
  // Tier B — cada 6 h
